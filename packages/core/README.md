...
[![npm version](https://img.shields.io/npm/v/@franxx/react-formsteps-core?style=flat-square&color=blue)](https://www.npmjs.com/package/@franxx/react-formsteps-core)
...
```bash
# npm
npm install @franxx/react-formsteps-core react-hook-form zod @hookform/resolvers

# pnpm
pnpm add @franxx/react-formsteps-core react-hook-form zod @hookform/resolvers

# yarn
yarn add @franxx/react-formsteps-core react-hook-form zod @hookform/resolvers
```
...
```bash
# npm
npm install @franxx/react-formsteps-core @franxx/react-formsteps-ui react-hook-form zod @hookform/resolvers
